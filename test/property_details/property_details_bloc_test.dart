...
// import 'package:ah/property_details/art_object_bloc.dart';
...
//     build: () {
//       when(() => mockPropertyRepository.getCollection(any())).thenAnswer((_) => Future.value(Right(_mockProperty)));
//
...
//     build: () {
//       when(() => mockPropertyRepository.getCollection(any())).thenAnswer((_) => Future.value(Left(_error)));
//
//       return PropertyDetailsBloc('the_id');
//     },
//     act: (bloc) => bloc.init(),
